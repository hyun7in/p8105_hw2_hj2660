...
The `MrTrashWheel_df` has 547 observations and 15 variables. The
`ProfTrashWheel_df` has 94 observations and 14 variables. The
`GwynTrashWheel_df` has 106 observations and 12 variables. The total
